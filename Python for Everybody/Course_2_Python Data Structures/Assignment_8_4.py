...
#  list and if not append it to the list. When the program completes, sort and print the resulting words in alphabetical order.
...
for line in fh:
    ...
    words = l.split()
    for word in words:
        if len(lst) is 0: lst.append(word)
        elif word not in lst: lst.append(word)
lst.sort()
print(lst)
