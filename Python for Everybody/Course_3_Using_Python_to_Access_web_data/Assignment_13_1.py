...
# to http://www.py4e.com/code3/urllink2.py. The program will use urllib to read the HTML from the data files 
...
# Actual data: http://py4e-data.dr-chuck.net/comments_455159.html (Sum ends with 34)
